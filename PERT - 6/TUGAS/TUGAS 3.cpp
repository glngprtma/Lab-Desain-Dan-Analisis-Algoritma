...
int main() {
    Mahasiswa* ptrMahasiswaAktif = new MahasiswaAktif("Gilang Pratama", 17, "Teknologi Informasi", "Informatika dan Pariwisata");
    cout << "Informasi Mahasiswa Aktif:" << endl;
    ptrMahasiswaAktif->dataMahasiswa();
    delete ptrMahasiswaAktif;
    cout << endl;

    Mahasiswa* ptrMahasiswaAlumni = new MahasiswaAlumni("Abdul", 30, "Dentist", "Kesehatan");
